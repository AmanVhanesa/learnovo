  ...
  return (
    <div className={`relative ${className}`}>
      <button
        ...
        className="flex items-center space-x-2 px-3 py-2 bg-white dark:bg-[#1C1C1E] border border-gray-300 dark:border-[#38383A] rounded-md shadow-sm hover:bg-gray-50 dark:hover:bg-[#2C2C2E] focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
      >
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-1 bg-white dark:bg-[#1C1C1E] border border-gray-300 dark:border-[#38383A] rounded-md shadow-lg z-50">
          <div className="py-1">
            {classes.map((classItem) => (
              <button
                key={classItem._id}
                onClick={() => handleClassSelect(classItem)}
                className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-50 dark:hover:bg-[#2C2C2E] ${
