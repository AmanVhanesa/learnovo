                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-[#38383A]">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 bg-teal-600 text-white rounded-md hover:bg-teal-700 transition disabled:bg-gray-400 dark:disabled:bg-[#38383A] flex items-center gap-2"
                                    disabled={printing}
                                >
                                    {printing ? 'Opening...' : (
                                        <>
