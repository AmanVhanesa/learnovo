...
const ModalWrapper = ({ title, onClose, maxWidth = 'max-w-2xl', children }) => {
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div
        className={`bg-white dark:bg-[#1C1C1E] rounded-none sm:rounded-2xl shadow-glass-lg ring-1 ring-black/[0.03] dark:ring-white/[0.06] ${maxWidth} w-full sm:mx-4 md:mx-auto h-full sm:h-auto sm:max-h-[90vh] overflow-hidden animate-scale-in`}
        onClick={(e) => e.stopPropagation()}
        style={{ backfaceVisibility: 'hidden', WebkitBackfaceVisibility: 'hidden' }}
      >
        <div className="h-full sm:h-auto sm:max-h-[90vh] overflow-y-auto bg-white dark:bg-[#1C1C1E]">
