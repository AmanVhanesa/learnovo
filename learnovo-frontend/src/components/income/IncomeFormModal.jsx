...
const IncomeFormModal = ({ income, categories, onClose, onSave }) => {
  const isEdit = !!income
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    if (!form.category || !form.title || !form.amount || !form.incomeDate) {
  ...
  return (
    <ModalWrapper title={isEdit ? 'Edit Income' : 'Add New Income'} onClose={onClose} maxWidth="max-w-2xl">
      <form onSubmit={handleSubmit} className="p-6">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="input"
                placeholder="e.g., Term 1 Fee Collection"
                required
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="label mb-1.5">Income Date <span className="text-red-500">*</span></label>
              <input
                type="date"
          ...
          {/* Received By */}
          <div>
            <label className="label mb-1.5">Received By</label>
            <input
              type="text"
