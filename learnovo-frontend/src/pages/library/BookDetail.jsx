...
const BookDetail = () => {
  ...
  return (
    <div className="space-y-6">
      <Link to="/app/library/books" className="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-emerald-600">
        <ArrowLeft className="h-4 w-4" /> Back to books
      </Link>

      <div className="bg-white dark:bg-[#1C1C1E] rounded-2xl border border-gray-100 dark:border-[#38383A] p-6 shadow-sm">
        <div className="flex items-start gap-4">
          <div className="p-3 bg-emerald-50 dark:bg-emerald-500/10 rounded-xl">
            <BookOpen className="h-6 w-6 text-emerald-600" />
          </div>
          <div className="flex-1">
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{book.title}</h1>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4 text-sm">
              ...
              <div><p className="text-xs text-gray-400 uppercase">Available</p><p className="font-semibold text-emerald-600">{book.availableCopies}</p></div>
      ...
      <div className="bg-white dark:bg-[#1C1C1E] rounded-2xl border border-gray-100 dark:border-[#38383A] shadow-sm">
