...
const buildCircularHTML = (circular, school, mode = 'print') => {
    ...
    const logoHtml = school.logo
        ? `<img src="${school.logo}" style="width:72px;height:72px;object-fit:contain;border-radius:8px" />`
        : '';
...
<style>
  *{margin:0;padding:0;box-sizing:border-box;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}
  ...
  .content{position:relative;z-index:1;display:flex;flex-direction:column;flex:1;padding:22px 26px}
  .header{display:flex;align-items:center;gap:14px;padding-bottom:12px;border-bottom:2px solid #3EC4B1}
  .header-text{flex:1}
  .school-name{font-family:'Playfair Display',Georgia,serif;font-size:22px;font-weight:800;color:#1F6F6D;letter-spacing:1.5px;line-height:1.1;text-transform:uppercase}
  ...
  .sig-line{width:160px;height:1px;background:#9ca3af;margin:36px auto 4px}
