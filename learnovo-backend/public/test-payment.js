...
async function startPayment() {
    var backendUrl = document.getElementById('backendUrl').value.replace(/\/$/, '');
    ...
    try {
        ...
        var orderResponse = await fetch(backendUrl + '/api/fee-payments/create-order', {
            method: 'POST',
            headers: {
        ...
        var options = {
            ...
            handler: async function (response) {
                ...
                try {
                    var verifyResponse = await fetch(backendUrl + '/api/fee-payments/verify', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'Authorization': 'Bearer ' + token
...
document.getElementById('payBtn').addEventListener('click', function() {
    ...
    startPayment().catch(function(err) {
