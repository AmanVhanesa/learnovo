...
const getTenantFromRequest = async(req, res, next) => {
  try {
    ...
    if (tenant.subscription && tenant.subscription.status === 'suspended') {
      ...
      const allowedWhenSuspended = ['/api/auth/login', '/api/auth/logout', '/api/auth/me', '/api/payments/plans', '/api/payments/create-order', '/api/payments/verify', '/api/payments/subscription', '/api/fee-payments/create-order', '/api/fee-payments/verify', '/api/fee-payments/webhook', '/api/student-fees/payment/icici-return', '/api/student-fees/payment/notify', '/health'];
    ...
    if (tenant.subscription && tenant.subscription.status === 'trial') {
      ...
      if (trialEnd && now > trialEnd) {
        ...
        const allowedAfterExpiry = ['/api/auth/login', '/api/auth/logout', '/api/auth/me', '/api/payments/plans', '/api/payments/create-order', '/api/payments/verify', '/api/payments/subscription', '/api/fee-payments/create-order', '/api/fee-payments/verify', '/api/fee-payments/webhook', '/api/student-fees/payment/icici-return', '/api/student-fees/payment/notify', '/health'];
