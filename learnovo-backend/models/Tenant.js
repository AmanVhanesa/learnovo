...
const tenantSchema = new mongoose.Schema({
  ...
  paymentGateway: {
    ...
    // ICICI Orange (PG Direct) credentials. Issued by ICICI on merchant
    // onboarding; the secureHashKey is generated by the merchant via the
    // ICICI dashboard's Key Management page. secureHashKey is encrypted
    // at rest via the pre-save hook below.
    iciciOrange: {
      merchantId: { type: String, default: '' },
      aggregatorId: { type: String, default: '' },
      secureHashKey: { type: String, default: '' },
      environment: { type: String, enum: ['uat', 'production'], default: 'production' }
    },
...
// Only the secureHashKey is encryption-worthy. merchantId/aggregatorId
// are not secret (they appear on the bank's dashboards and receipts).
const SENSITIVE_ICICI_ORANGE_FIELDS = ['secureHashKey'];
